...
public JuegoLaberinto3 juegoLaberinto;
Image[] puertas={puertaapagada,puerta};

 public Puerta(JuegoLaberinto3 juegoLaberinto,int px, int py){
  this.juegoLaberinto= juegoLaberinto;  
  x=px;  y=py;
 }
  public void paint(Graphics2D g ){
      if(juegoLaberinto.item.score>0&&juegoLaberinto.boton.activacion==1){
          numpuertas=1;

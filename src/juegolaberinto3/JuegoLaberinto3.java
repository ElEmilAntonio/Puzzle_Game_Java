...
public class JuegoLaberinto3 extends JPanel {
...
int numeronivel=1;
   Boton boton= new Boton(this);
    Personaje personaje = new Personaje(this,560,400);
   ...
   Cuadro cuadro= new Cuadro(this);
    ...
    Pared pared4 = new Pared(this,200,440,400,200);
    Pared pared5 = new Pared(this,280,80,360,280);
    Pared pared6 = new Pared(this,200,40,40,320);
    ...
    public void ColisionesDelJuegoNivel3() {
    ...
    public void main() {
        ...
        JuegoLaberinto3 juegoLaberinto = new JuegoLaberinto3();
        ...
        pantalla.setVisible(true);
         while (true) {
            juegoLaberinto.repaint();
              juegoLaberinto.ColisionesDelJuegoNivel3();
               if(juegoLaberinto.personaje.reiniciar==true){
                 Musica3.Mnivel3.stop();
              ...
              if (juegoLaberinto.puerta.ColisionPuerta()) {
                Musica3.Mnivel3.stop();
                JOptionPane.showMessageDialog(null, "acabaste el nivel 3", "final", JOptionPane.YES_NO_OPTION);
                 pantalla.setVisible(false);
                juegoLaberinto=null;
                 break;
            }
